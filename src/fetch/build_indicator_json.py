...
def main():
    ...
    indicator_json = metadata_path / "indicator.json"

    with open(indicator_json, 'w') as file:
        json.dump(indicators, file, indent=4)
        print(f"indicator.json saved to: {indicator_json.parent}")
...
indicators = {
    "macroeconomic": {
        ...
        "central_bank_policy_rate": {
            ...
            "description": "The interest rate set by the central bank.",
            "oecd": "IR3TIB01"
        }
    },
    "trade-and-commerce": {
    ...
    "political-and-policy-environment": {
        "political_stability_and_absence_of_violence_terrorism_percentile_rank": {
            ...
            "description": "Measures political stability.",
            "world_bank": "PV.EST"
        },
        "ease_of_doing_business_rank": {
            "title": "Ease of Doing Business Rank",
            "description": "Measures regulatory environment for businesses.",
            "world_bank": "IC.BUS.EASE.XQ"
        }
    },
    "energy": {
        ...
        "co2_emissions_metric_tons_per_capita": {
            ...
            "description": "Per capita carbon emissions.",
            "world_bank": "EN.ATM.CO2E.PC"
        },
        ...
        "heolic_energy_production": {
            "title": "Heolic Energy Production",
            "description": "Amount of energy produced by wind sources.",
            "world_bank": "EG.ELC.WND.ZS"
        },
        "solar_energy_production": {
            "title": "Solar Energy Production",
            "description": "Amount of energy produced by solar sources.",
            "world_bank": "EG.ELC.RNW.XS"
        },
    ...
    "global-economic-linkages": {
        "participation_in_global_value_chains_gvc_index": {
            "title": "Participation in Global Value Chains (GVC) Index",
            "description": "Involvement in global value chains.",
            "oecd": "TIVA_2015_C2"
        },
    ...
    "commodities": {
        "iron_ore_steel": {
            ...
            "description": "Production and export volumes.",
            "world_bank": "CM.STEEL"
        },
        "potato": {
            "title": "Potato",
    ...
    "production": {
        "car_production": {
            ...
            "world_bank": "IP.PRD.CARS"
        },
        "micro_chip_production": {
            "title": "Micro Chip Production",
            "description": "Production volume.",
            "world_bank": "IP.PRD.CHIP"
        },
        "computer_production": {
            "title": "Computer Production",
            "description": "Production volume.",
            "world_bank": "IP.PRD.COMP"
        },
        "cheese_production": {
            "title": "Cheese Production",
            "description": "Production volume.",
            "world_bank": "IP.PRD.CHSE"
        },
        "beer_production": {
            "title": "Beer Production",
            "description": "Production volume.",
            "world_bank": "IP.PRD.BEER"
        },
        "wine_production": {
            "title": "Wine Production",
            "description": "Production volume.",
            "world_bank": "IP.PRD.WINE"
        }
    },
    "geographic": {
        "area": {
        ...
        "civil_construction": {
            ...
            "description": "Area of construction activity.",
            "oecd": "IC.BUS.CNST"
        }
    },
    "education": {
